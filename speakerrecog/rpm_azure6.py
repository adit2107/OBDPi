...
def iothub_client_telemetry_sample_run(uid,otp):
    ...
    try:
        ...
        while True:
                if(GPIO.input(buttonPin) == 0):
                    ...
                    if (secs == 0):
                            ...
                            # Check otp timer here
                            
                    elif (secs > 0):
                            if (msgobdspeed > int(speedval)):
                                    sendSpeedPush()
        ...
        f.close()
            ...
            speakrec.speak("Your trip has ended.")
            os.system("/usr/bin/java otpset")
           #s.system("/usr/bin/python3 master.py")
